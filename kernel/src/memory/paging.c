...
/*!
    @brief Initialize the paging module.

    Sets the HHDM offset used for the kernels page tables.
    Initializes the free list for early page table allocation (before the VMM is setup).
