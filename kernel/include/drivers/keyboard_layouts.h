/*!
    @file keyboard_layouts.h

    @brief Definitions of keyboard layouts.
    
    Defines a structure for defining keyboard layouts and provides the German QWERTZ layout.
...
/*!
    @brief Structure to describe a keyboard layout.

    Contains information about the characters generated by key in different modifier states in form of a look up table.
*/
...
/*!
    @brief German QWERTZ keyboard layout.
    
    @note For now only ASCII characters are supported because there are no bitmaps for other characters.
    @note The "Umlaute" "ä", "ö" and "ü" are replaced with "ae", "oe" and "ue". "ß" is replaced with "ss".
*/
